...
def compute_merge_table(fname):
    ...
    results_outputX, results_volumeX, results_num_training_pointsX = extract_merge_attributes(coefs1, intercepts1, 3, bounded_X_train1, bounded_test_x)
    results_outputY, results_volumeY, results_num_training_pointsY = extract_merge_attributes(coefs2, intercepts2, 3, bounded_X_train2, bounded_test_x)
    ...
    csv_filename = f"merge_attributes_{fname}.csv"
